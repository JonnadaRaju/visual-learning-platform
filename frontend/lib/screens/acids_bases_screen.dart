...
class AcidsBasesScreen extends ConsumerStatefulWidget {
  const AcidsBasesScreen({super.key});

  @override
  ConsumerState<AcidsBasesScreen> createState() => _AcidsBasesScreenState();
}

class _AcidsBasesScreenState extends ConsumerState<AcidsBasesScreen>
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => _showAiExplanation(context, 'acids-bases'),
          ),
        ],
      ),
      body: Column(
